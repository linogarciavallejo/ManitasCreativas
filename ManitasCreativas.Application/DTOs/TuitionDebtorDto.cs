...
namespace ManitasCreativas.Application.DTOs
{
    public class TuitionDebtorDto
    {
        ...
        public List<UnpaidTuitionDto> UnpaidTuitions { get; set; } = new();
    ...
    public class TuitionDebtorsReportDto
    {
        ...
        public List<TuitionDebtorDto> Debtors { get; set; } = new();
        public TuitionDebtorsSummaryDto Summary { get; set; } = new();
    }

    public class TuitionDebtorsSummaryDto
    {
    ...
    public class TuitionDebtorsFilterDto
    {
        public int? Year { get; set; }
        public int? Month { get; set; }
